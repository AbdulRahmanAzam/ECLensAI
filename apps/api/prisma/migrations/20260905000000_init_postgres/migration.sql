...
CREATE TABLE "PortfolioSnapshot" (
    ...
    "totalGrossExposure" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "totalEcl" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "coverageRatio" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "stage3Share" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "importBatchId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Exposure" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'PKR',
    "grossCarryingAmount" DECIMAL(65,30) NOT NULL,
    "undrawnCommitment" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "creditConversionFactor" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "effectiveInterestRate" DECIMAL(65,30) NOT NULL,
    "daysPastDue" INTEGER NOT NULL DEFAULT 0,
    "originalCreditRating" TEXT NOT NULL,
    "currentCreditRating" TEXT NOT NULL,
    "twelveMonthPd" DECIMAL(65,30) NOT NULL,
    "lifetimePd" DECIMAL(65,30) NOT NULL,
    "pdAtOrigination" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "lgd" DECIMAL(65,30) NOT NULL,
    "collateralValue" DECIMAL(65,30) NOT NULL DEFAULT 0,
...
CREATE TABLE "ExposureEadPeriod" (
    ...
    "drawnBalance" DECIMAL(65,30) NOT NULL,
    "undrawnCommitment" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "ScenarioSet" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "approvalStatus" "ScenarioApprovalStatus" NOT NULL DEFAULT 'PENDING',
    "approvedById" TEXT,
    "approvedBy" TEXT,
...
CREATE TABLE "ScenarioFactor" (
    ...
    "pdMultiplier" DECIMAL(65,30) NOT NULL,
    "lgdMultiplier" DECIMAL(65,30) NOT NULL,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "description" TEXT NOT NULL DEFAULT '',
    "indicators" JSONB,
...
CREATE TABLE "ModelConfiguration" (
    ...
    "lgdFloor" DECIMAL(65,30) NOT NULL,
    "lgdCeiling" DECIMAL(65,30) NOT NULL,
    "pdFloor" DECIMAL(65,30) NOT NULL,
    "pdCeiling" DECIMAL(65,30) NOT NULL,
    "lifetimeHorizonMonthsCap" INTEGER NOT NULL,
    "maxCalculationPeriods" INTEGER NOT NULL,
    "discountConvention" TEXT NOT NULL,
    "effectiveInterestRateMin" DECIMAL(65,30) NOT NULL,
    "effectiveInterestRateMax" DECIMAL(65,30) NOT NULL,
    "defaultCreditConversionFactor" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "EclResult" (
    ...
    "grossCarryingAmount" DECIMAL(65,30) NOT NULL,
    "eadAtReportingDate" DECIMAL(65,30) NOT NULL,
    ...
    "effectiveInterestRate" DECIMAL(65,30) NOT NULL,
    "discountConvention" TEXT NOT NULL,
    "lifetimePdAtReportingDate" DECIMAL(65,30) NOT NULL,
    "lossAllowance" DECIMAL(65,30) NOT NULL,
    "netCarryingAmount" DECIMAL(65,30) NOT NULL,
    "coverageRatio" DECIMAL(65,30) NOT NULL,
    "coverageOfEad" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "EclScenarioResult" (
    ...
    "lgdMultiplier" DECIMAL(65,30) NOT NULL,
    "horizonMonths" INTEGER NOT NULL,
    "unweightedEcl" DECIMAL(65,30) NOT NULL,
    "weightedEcl" DECIMAL(65,30) NOT NULL,
    "cumulativePdInHorizon" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "EclCalculationPeriod" (
    ...
    "marginalPd" DECIMAL(65,30) NOT NULL,
    "cumulativePd" DECIMAL(65,30) NOT NULL,
    "lgd" DECIMAL(65,30) NOT NULL,
    "ead" DECIMAL(65,30) NOT NULL,
    "discountFactor" DECIMAL(65,30) NOT NULL,
    "expectedLoss" DECIMAL(65,30) NOT NULL,
    "weightedExpectedLoss" DECIMAL(65,30) NOT NULL,
...
CREATE TABLE "Document" (
    ...
    "processingStatus" "DocumentProcessingStatus" NOT NULL DEFAULT 'QUEUED',
    "message" TEXT NOT NULL DEFAULT '',
    "documentType" TEXT,
    "summary" TEXT,
    "extraction" JSONB,
